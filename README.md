...
- В .env указать:
    ...
    * порт {DB_PORT}
- В .env указать proxy_url `http://LOGIN:PASSWORD@IP:PORT`
...
- Зайти на приложение http://150.241.64.249:6276/, зарегистрироваться (sign up) или авторизоваться (log in).
...
- Укажите ссылку строго по этому примеру
  https://yandex.ru/maps/org/{любое_наименование_организации}/{id_организации}/reviews/
